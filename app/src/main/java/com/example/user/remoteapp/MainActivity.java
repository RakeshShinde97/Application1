package com.example.user.remoteapp;
...
public class MainActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_connect) {
            ...
            connectPhoneTask.execute(SyncStateContract.Constants.SERVER_IP); //try to connect to server in another thread
            return true;
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.nextButton:
                if (isConnected && out!=null) {
                    out.println(SyncStateContract.Constants.NEXT); //send "next" to server
                }
                break;
            case R.id.previousButton:
                if (isConnected && out!=null) {
                    out.println(SyncStateContract.Constants.PREVIOUS); //send "previous" to server
                }
                break;
        }
